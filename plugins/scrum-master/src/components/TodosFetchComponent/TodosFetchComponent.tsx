...
export const DenseTableTodo = ({ items }: DenseTableTodoProps) => {
  // const classes = useStyles();
...
export const TodosFetchComponent = () => {
  ...
  return <DenseTableTodo items={value || []} />;
